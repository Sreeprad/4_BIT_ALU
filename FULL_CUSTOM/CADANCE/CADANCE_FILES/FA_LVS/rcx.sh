#!/bin/ksh
# This script was generated Fri Jun 21 19:23:34 2024 by:
#
...
#	/home/klu/Desktop/SDC_project/FA_LVS.xcn -assura_run_dir \
#	/home/klu/Desktop/SDC_project -assura_run_name FA_LVS -rcxdir \
#	/home/klu/Desktop/SDC_project/FA_LVS -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir \
#	/home/klu/Desktop/SDC_project/FA_LVS/rcx_temp -sub_node_char # \
...
#	/home/klu/Desktop/SDC_project/FA_LVS/extview.tmp -net_name_space \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/klu/Desktop/SDC_project/FA_LVS/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/klu/Desktop/SDC_project/FA_LVS
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/klu/Desktop/SDC_project/FA_LVS/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/klu/Desktop/SDC_project/FA_LVS/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/klu/Desktop/SDC_project/FA_LVS
...
/home/klu/Desktop/SDC_project/FA_LVS.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/klu/Desktop/SDC_project FA_LVS -unit meters -mFactorR -- -V1 \
	-H satfile -r /home/klu/Desktop/SDC_project/FA_LVS.xcn -df2 -xgl
...
flattenLayers -m metal2_conn metal1_conn poly_conn ndiff_conn pdiff_conn \
	...
	ntap_ndiff_conn_ovia ntap nwell_conn_ntap_ovia _nmos_12_MOS_1_orig \
	_pmos_12_MOS_7_orig
endFlattenInputs
...
mergevia -V -tech /home/install/FOUNDRY/analog/90nm/assura/rcx -cnt np_rVia1 \
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -ignore_cf_table -scf sip.cmd -cgnd \
	...
	poly:poly_cut mt1:mt1_cut mt2:mt2_cut mt3 mt4 mt5 mt6 mt7 mt8 mt9 \
	allGate - /home/install/FOUNDRY/analog/90nm/assura/rcx/qrcTechFile - \
	- NET - capfile
...
xreduce -V -mergecap -n NET -tech \
	...
	rVia1.res,rcont_poly.res,rcont_pdiff.res,rcont_ndiff.res -rP \
	np_rpoly_conn.res,np_rmetal1_conn.res,np_rmetal2_conn.res,mwires.res \
	-cap capfile L1T0 _nmos_12_MOS_1.transr _pmos_12_MOS_7.transr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	rcont_ndiff.res,Rrcont_ndiff.dev2 -rPmw mwires.mod \
	...
	/home/klu/Desktop/SDC_project/FA_LVS/extview.tmp
