...
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt4 -b mt1,poly,diff,sti -t 	mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt2:mt2_cut,key,mt4,key 0,2.1,0 - 	mt2_mt4.sip
sip -V -s -cgnd 2 -sub 2 -h -b mt1,poly,diff,sti -t 	mt4,mt5,mt6,mt7,mt8,mt9 -Maxw 2.1 -p mt2:mt2_cut,key,mt3,key 0,2.1,0 	- mt2_mt3.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R mt3 -b poly,diff,sti -t 	mt4,mt5,mt6,mt7,mt8,mt9 -k mt2:0.36 -Maxw 2.1 -p 	mt1:mt1_cut,key,mt3,key 0,2.1,0 - mt1_mt3.sip
