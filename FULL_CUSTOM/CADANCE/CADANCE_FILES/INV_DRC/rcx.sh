#!/bin/ksh
# This script was generated Fri Jun 14 16:36:24 2024 by:
#
...
#	/home/klu/Desktop/SDC_project/INV_DRC.xcn -assura_run_dir \
#	/home/klu/Desktop/SDC_project -assura_run_name INV_DRC -rcxdir \
#	/home/klu/Desktop/SDC_project/INV_DRC -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir \
#	/home/klu/Desktop/SDC_project/INV_DRC/rcx_temp -sub_node_char # \
...
#	/home/klu/Desktop/SDC_project/INV_DRC/extview.tmp -net_name_space \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/klu/Desktop/SDC_project/INV_DRC/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/klu/Desktop/SDC_project/INV_DRC
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/klu/Desktop/SDC_project/INV_DRC/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/klu/Desktop/SDC_project/INV_DRC/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/klu/Desktop/SDC_project/INV_DRC
...
/home/klu/Desktop/SDC_project/INV_DRC.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/klu/Desktop/SDC_project INV_DRC -unit meters -mFactorR -- -V1 \
	-H satfile -r /home/klu/Desktop/SDC_project/INV_DRC.xcn -df2 -xgl
...
rex -V -m -pd -I'#' -tech /home/install/FOUNDRY/analog/90nm/assura/rcx -map \
	p2elayermapfile -N NET -e2 -rP res.mod np_rpoly_conn::poly_cut \
	np_rmetal1_conn::mt1_cut - rMetal1_v,2 rcont_ndiff,2,t \
	rcont_pdiff,2,t rcont_poly,1,2,t - L1T0,2,I
...
xreduce -V -mergecap -n NET -tech \
	...
	np_rpoly_conn.res,np_rmetal1_conn.res -cap capfile L1T0
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	NET - /home/klu/Desktop/SDC_project/INV_DRC/extview.tmp
